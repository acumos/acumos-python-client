...
def _create_requirement_set(requirements):
    ...
    pkg_names = requirements.package_names
    filtered_reqs = {req for req in mapped_reqs if req not in pkg_names}
