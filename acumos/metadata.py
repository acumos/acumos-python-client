...
def create_model_meta(model, name, requirements, encoding='protobuf'):
    ...
    return {'schema': _SCHEMA,
            ...
            'methods': {name: {'input': {'name': f.input_type.__name__,
                                         'media_type': MODEL_MEDIA.append(_MEDIA_TYPES[encoding if _is_namedtuple(f.input_type) else f.input_type.__supertype__._raw_type]),
                               ...
                               'output': {'name': f.output_type.__name__,
                                          'media_type': MODEL_MEDIA.append(_MEDIA_TYPES[encoding if _is_namedtuple(f.output_type) else f.output_type.__supertype__._raw_type]),
