...
def test_raw_type():
    ...
    f2_in = Image(b'test bytes', {'dcae_input_name': 'a', 'dcae_output_name': 'a'}, 'example description')
    f2_out = Image(b'test bytes', {'dcae_input_name': 'a', 'dcae_output_name': 'a'}, 'example description')
    f2_in_media_type = ["application/octet-stream"]
    f2_out_media_type = ["application/octet-stream"]

    f3_in = Dictionary({'a': 1, 'b': 2}, {'dcae_input_name': 'a', 'dcae_output_name': 'a'}, 'example description')
    f3_out = Dictionary({'a': 1, 'b': 2}, {'dcae_input_name': 'a', 'dcae_output_name': 'a'}, 'example description')
