...
def test_raw_type():
    ...
    # Text = NewType("Text", Raw(str, {'dcae_input_name': 'a', 'dcae_output_name': 'a'}, 'example description'))
    ...
    f1_in = Text(Raw("test string", {'dcae_input_name': 'a', 'dcae_output_name': 'a'}, 'example description'))
    f1_out = Text(Raw("test string", {'dcae_input_name': 'a', 'dcae_output_name': 'a'}, 'example description'))
...
def _raw_type_test(func, in_, out, in_media_type, out_media_type, wrapped_eq=eq, pb_mg_eq=eq, pb_bytes_eq=eq, dict_eq=eq, json_eq=eq, reqs=None, skip=None):
